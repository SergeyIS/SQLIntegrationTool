...
{
    internal class InitToApplication : Application
    {
        public override Task Run(CommandLineArguments obj)
        {
            ...
            return Task.Run(() => {
                ...
                this._configuration.ToConnectionString = $"Data Source={obj.Server};Initial Catalog={obj.Database};User Id={obj.User};Password={obj.Password};";
            });
        }
    }
}